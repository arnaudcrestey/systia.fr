        ...
        <div className="grid gap-12 sm:gap-14 md:grid-cols-[minmax(0,1.35fr)_180px_220px] md:items-start md:justify-between md:gap-16">
            ...
            <div className="w-full max-w-[420px] md:max-w-[500px]">
              <div className="mx-auto flex flex-col items-center text-center">
                ...
                <p
                  className={
                    serif.className +
                    " mt-5 max-w-[20rem] text-[17px] italic leading-[1.7] text-[#5b6474] sm:max-w-[30rem] sm:text-[20px]"
                  }
                >
                  <span className="block">Clarifier l’activité, structurer l’offre</span>
                  <span className="block">et concevoir les dispositifs qui</span>
                  <span className="block">génèrent des demandes.</span>
                </p>
          ...
          <div className="flex justify-center md:block md:justify-self-center order-2">
            <div className="w-full max-w-[220px] text-center md:w-[180px] md:text-left">
              ...
              <h3 className={inter.className + " text-[11px] font-semibold uppercase tracking-[0.2em] text-[#0f172a]"}>
                Navigation
              </h3>

              <nav className="mt-5 flex flex-col items-center gap-4 md:items-start">
                <Link href="/" className={inter.className + " text-[14px] text-[#475569] hover:text-[#1d4ed8]"}>Accueil</Link>
                <Link href="/systeme" className={inter.className + " text-[14px] text-[#475569] hover:text-[#1d4ed8]"}>Le système</Link>
                <Link href="/concepts" className={inter.className + " text-[14px] text-[#475569] hover:text-[#1d4ed8]"}>Concepts</Link>
                <Link href="/a-propos" className={inter.className + " text-[14px] text-[#475569] hover:text-[#1d4ed8]"}>À propos</Link>
                <Link href="/tarifs" className={inter.className + " text-[14px] text-[#475569] hover:text-[#1d4ed8]"}>Tarifs</Link>
              </nav>
          ...
          <div className="flex justify-center md:block md:justify-self-end order-3 mt-4 sm:mt-6 md:mt-0">
            <div className="w-full max-w-[260px] text-center md:w-[220px] md:text-left">
              ...
              <h3 className={inter.className + " text-[12px] font-semibold uppercase tracking-[0.24em] text-[#0f172a]"}>
                Coordonnées
              </h3>
        ...
        <div className="mt-12 border-t border-[#d9def8] pt-6">
          <div className={inter.className + " flex flex-col gap-3 text-center text-[14px] text-[#64748b] md:flex-row md:items-center md:justify-between md:text-left"}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 md:justify-end">
              ...
              <Link href="/politique-de-confidentialite" className="hover:text-[#1d4ed8]">Politique de confidentialité</Link>
              <Link href="/politique-de-cookies" className="hover:text-[#1d4ed8]">Politique de cookies</Link>
            </div>
          </div>
        </div>
